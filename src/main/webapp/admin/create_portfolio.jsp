            ...
            <div class="col-xl-3 col-lg-3 d-md-none d-lg-block col-sm-12">
                <div class="speakers w-75">
                    <div class="spk-img">
                        ...
                        <ul>
                            <li>
                                <a href="../Portfolio_1/index.jsp?userId=<%= encodedString %>" target="_blank" style="color: white; font-size: 16px;">Preview</a>
                            </li>
                        </ul>
                    </div>
                    <div class="spk-info">
                        <h3>Template 1</h3>
                        <button id="pf1" type="button" class="btn btn-link" value="http://localhost:8080/portfolyio/Portfolio_1/index.jsp?userId=<%= encodedString %>" onclick="getURL(this.id)">Copy</button>
                    </div>
                </div>
            </div>
            <!-- /col end-->
            ...
            <div class="col-xl-3 col-lg-3 d-md-none d-lg-block col-sm-12">
                <div class="speakers w-75">
                    ...
                    <div class="spk-info">
                        ...
                        <button id="pf2" type="button" class="btn btn-link" value="http://localhost:8080/portfolyio/Portfolio_2/index.jsp?userId=<%= encodedString %>" onclick="getURL(this.id)">Copy</button>	
                    </div>
                </div>
            </div>
            <!-- /col end-->
